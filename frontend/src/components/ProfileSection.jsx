                ...
                <div className="contact-section">
                    ...
                    <div className="contact-links">
                        ...
                        {profile.portfolio_url && (
                            <a href={profile.portfolio_url} target="_blank" rel="noopener noreferrer" className="contact-link">
                                <span className="contact-icon">🌐</span>
                                <span>Portfolio</span>
                            </a>
                        )}
                        {profile.resume_url && (
                            <a href={profile.resume_url} target="_blank" rel="noopener noreferrer" className="contact-link highlight">
                                <span className="contact-icon">📄</span>
